...
convert -background none geopuntAddress16x16.png geopuntAddress24x24.png geopuntAddress32x32.png geopuntAddress48x48.png geopuntAddress256x256.png geopuntAddress.ico
convert -background none geopuntCatalog16x16.png geopuntCatalog24x24.png geopuntCatalog32x32.png geopuntCatalog48x48.png geopuntCatalog256x256.png geopuntCatalog.ico
convert -background none geopuntPerceel16x16.png geopuntPerceel24x24.png geopuntPerceel32x32.png geopuntPerceel48x48.png geopuntPerceel256x256.png geopuntPerceel.ico
convert -background none geopuntBatch16x16.png geopuntBatch24x24.png geopuntBatch32x32.png geopuntBatch48x48.png geopuntBatch256x256.png geopuntBatch.ico
convert -background none geopuntElevation16x16.png geopuntElevation24x24.png geopuntElevation32x32.png geopuntElevation48x48.png geopuntElevation256x256.png geopuntElevation.ico
convert -background none geopuntGipod16x16.png geopuntGipod24x24.png geopuntGipod32x32.png geopuntGipod48x48.png geopuntGipod256x256.png geopuntGipod.ico
convert -background none geopuntPoi16x16.png geopuntPoi24x24.png geopuntPoi32x32.png geopuntPoi48x48.png geopuntPoi256x256.png geopuntPoi.ico
convert -background none geopuntReverse16x16.png geopuntReverse24x24.png geopuntReverse32x32.png geopuntReverse48x48.png geopuntReverse256x256.png geopuntReverse.ico
convert -background none geopuntSetting16x16.png geopuntSetting24x24.png geopuntSetting32x32.png geopuntSetting48x48.png geopuntSetting256x256.png geopuntSetting.ico
